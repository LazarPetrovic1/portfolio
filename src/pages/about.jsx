...
import {
  ...
  aboutAriaLabelledBy2,
  imageAriaLabelledBy2,
    ...
    <AnimatedPage>
      <article className="text-holder scroller" style={{ maxHeight: scrollerBottomPushBack, paddingRight: '1.5rem' }}>
        ...
        <AboutSection>
          ...
          <div>
            <img tabIndex={-1} aria-labelledby={imageAriaLabelledBy1} src={di} alt="Digital Infinity D.O.O." height={250} width={250} />
          </div>
        </AboutSection>

        <AboutSection>
          <div tabIndex={-1} aria-labelledby={imageAriaLabelledBy2}>
            <img src={rcmt} alt="RCMT IT Europe" height={170} width={170} />
          </div>
          <div tabIndex={-1} aria-labelledby={aboutAriaLabelledBy2}>
