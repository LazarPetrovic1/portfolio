    ...
    <AnimatedPage>
      <article className="text-holder scroller" style={{ maxHeight: scrollerBottomPushBack, paddingRight: '1.5rem' }}>
        ...
        <AboutSection>
          ...
          <div tabIndex={-1} aria-labelledby={aboutAriaLabelledBy1} role="textblock">
        ...
        <AboutSection>
          <div
            style={{ order: width <= 700 ? 1 : 0 }}
            tabIndex={-1}
            aria-labelledby={aboutAriaLabelledBy3}
            role="textblock"
          >
          ...
          <div tabIndex={-1} aria-labelledby={imageAriaLabelledBy3} style={{ order: width <= 700 ? 0 : 1 }}>
        ...
        <AboutSection>
          ...
          <div role="textblock" tabIndex={-1} aria-labelledby={aboutAriaLabelledBy4}>
        ...
        <AboutSection>
          <div role="textblock" style={{ order: width <= 700 ? 1 : 0 }} tabIndex={-1} aria-labelledby={aboutAriaLabelledBy5}>
          ...
          <div tabIndex={-1} aria-labelledby={imageAriaLabelledBy5} style={{ order: width <= 700 ? 0 : 1 }}>
        ...
        <AboutSection>
          ...
          <div role="textblock" tabIndex={-1} aria-labelledby={aboutAriaLabelledBy4}>
            ...
            I am currently working on a whole slew of different Microsoft projects. The most important work I've done relates to accessibility of their newest user-facing product - the operating system Windows 11, which boasts 2 new accessibility features - namely the Narrator, which reads the UI for visually-impaired users and Voice Access, which allows for hands-free use of a computer device.<br />
            Given that these projects are quite complicated, most of my work contains of catching fixing and mistakes and improving accessibility for all users while cutting down on load times.<br />
            Having joined the organization right around the rise of LLMs and AI, implementing them into front-end application became the norm and knowing how to add them into apps and properly coordinate API calls, and take care of race conditions, in order to reduce the loading speed and take care of errors, was expected of developers.<br />
            However, having mastered most of the architecture, days became long, boring and micro managed instead of fun and action-packed and autonomous, so I decided to quit and am now actively seeking a more challenging role.
          </div>
        </AboutSection>
      </article>
    </AnimatedPage>
