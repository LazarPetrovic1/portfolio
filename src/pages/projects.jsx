import { Accordion, AnimatedPage } from "../components";
...
const { blog, flourish, photoapp, impulse, musicplayer, seezassignment, raspberrySpy, zeitmeister, financier } = projectinformation;
    ...
    <AnimatedPage>
      <div className="text-holder scroller" style={{ maxHeight: scrollerBottomPushBack, paddingRight: '1.5rem' }}>
        ...
        <Accordion title="Desktop applications">
          ...
          <ProjectContainer>
            <ProjectTitle>{financier.title}</ProjectTitle>
            <ReactImageGallery items={financier.images} />
            <ProjectText>
              <div>
                <p>Tech Stack:</p>
                <p>{financier.DE}</p>
                ...
                <p>Features</p>
                <ul>
                  {financier.features.map((f, i) => <li key={i}>{f}</li>)}
                </ul>
              </div>
            </ProjectText>
            <hr />
          ...
          <ProjectContainer>
            <ProjectTitle>{zeitmeister.title}</ProjectTitle>
            <ReactImageGallery items={zeitmeister.images} />
            <ProjectText>
              <div>
                <p>Tech Stack:</p>
                <p>{zeitmeister.DE}</p>
                ...
                <p>Features</p>
                <ul>
                  {zeitmeister.features.map((f, i) => <li key={i}>{f}</li>)}
                </ul>
              </div>
            </ProjectText>
            <hr />
        ...
        <Accordion title="Complex applications & Cybersecurity">
          <ProjectContainer>
